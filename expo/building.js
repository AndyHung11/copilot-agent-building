...
(function () {
  ...
  function buildShellReal() {
    ...
    const nameTex = textTexture(T("parkSign"), 1120, 150, "800 76px 'Segoe UI'", "#eaf2ff", "#2f6fd0");
  ...
  function retextureScene() {
    ...
    if (shellGroup.userData.nameP) {
      ...
      m.map.dispose();
      m.map = textTexture(T("parkSign"), 1120, 150, "800 76px 'Segoe UI'", "#eaf2ff", "#2f6fd0");
      m.needsUpdate = true;
    }
    if (plazaGroup.userData.title) {
      const m = plazaGroup.userData.title.material;
      m.map.dispose();
      m.map = textTexture(T("plazaWelcome"), 1180, 112, "800 52px 'Segoe UI'", "#dbe8ff", "#2f6fd0");
      m.needsUpdate = true;
    }
