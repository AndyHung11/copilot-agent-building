const ZONES = [
  ...
  },
  {
    "id": "Z2",
    "name": "行銷創意館",
    "nameEn": "Marketing & Creative Hall",
    "icon": "🎨",
    "color": "#ff6f91",
    "count": 8
  },
  ...
  },
  {
    "id": "Z7",
    "name": "產品創新館",
    "nameEn": "Product & Innovation Hall",
    "icon": "🚀",
    "color": "#00c2d1",
    "count": 5
  },
...
const AGENTS = [
  ...
  },
  {
    ...
    "example": "幫我建立一份 3 人外科術前準備團隊的清單，涵蓋設備設置、消毒流程與溝通協議。",
    "license": "free"
  },
  {
    "id": "A020",
  ...
  },
  {
    ...
    "example": "學習素材建立：請幫我為新軟體培訓建立互動模組。\n語調設定：請幫我調整這份培訓手冊的語調，讓它更具支持性。",
    "license": "free"
  },
  {
    "id": "A022",
    ...
    "example": "我有個決定一直無法做，請比較 A、B、C 三個選項，評估標準為成本、速度和品質，其中成本最重要。",
    "license": "free"
  },
  {
    "id": "A023",
  ...
  },
  {
    ...
    "example": "顯示 [產業/技術] 的新興趨勢，並舉例說明我們如何在 [特定團隊或專案] 中應用這些趨勢。",
    "license": "required"
  },
  {
    "id": "A025",
    ...
    "example": "將這些原始想法轉化為包含角色與目標的結構化使用者故事。",
    "license": "free"
  },
  {
    "id": "A026",
    ...
    "example": "幫我識別所提供資訊中的錯位、矛盾和不一致之處。",
    "license": "free"
  },
  {
    "id": "A027",
    ...
    "example": "幫我為來年規劃一個清晰的計畫，並引導我將這些計畫轉化為可行、可達成的目標。",
    "license": "free"
  },
  {
    "id": "A028",
    ...
    "example": "幫我針對目標受眾調整我的故事，並釐清情境脈絡。",
    "license": "free"
  },
  {
    "id": "A029",
  ...
  },
  {
    ...
    "example": "你能幫我針對 [特定領域/同事] 撰寫建設性的回饋嗎？",
    "license": "free"
  },
  {
    "id": "A031",
    ...
    "example": "客戶會議 - 審查我的簡報 - 60 分鐘，保留 10 分鐘 Q&A，受眾為高階主管客戶。\n內部會議 - 審查我的簡報 - 60 分鐘，保留 15 分鐘 Q&A，受眾為內部同仁。",
    "license": "free"
  },
  {
    "id": "A032",
  ...
  },
  {
    ...
    "headline": "OKR 教練！",
    "tagline": "✨ 把模糊的策略目標拆成可量化的 OKR 與對應行動方案",
  ...
  },
  {
    ...
    "tagline": "✨ 一次生出多組 A/B 測試假設，變數與預期 KPI 都寫好",
  ...
  },
  {
    ...
    "headline": "魔鬼辯護人！",
    "tagline": "✨ 上台前先被電一輪，把隱藏假設與最難的問題都問完",
  ...
  },
  {
    ...
    "headline": "團隊士氣激勵助手！",
    "tagline": "✨ 依團隊規模與工作模式，給你辦得起來的士氣提振方案",
  ...
  },
  {
    ...
    "emoji": "📜",
    "cname": "合約審閱 Agent",
    "ename": "Contract Review Agent",
    "headline": "把合約丟給它，逐節標出風險、模糊條款與缺漏，還回你一份加了黃底註解的 Word",
    "tagline": "✨ 逐節挑出風險與模糊 → 點名缺漏的標準條款 → 產出加註解的 Word 📜",
    "description": "一個會審閱合約的 Agent，找出風險、缺漏條款與法遵疑慮，並提出改善建議。它會產出一份修訂版合約，以註腳形式對應所有意見。不需 M365 Copilot 授權。",
    "painPoints": [
      "二十八頁合約 你不是法務 卻得先看過",
      "「合理期間內」 到底是多久 沒人講清楚",
      "缺了保密條款 最難發現的 是「沒寫的東西」"
    ],
    "quickStart": [
      "建立 Contract Review Agent，把官方 Agent Instructions 整段貼進去；知識來源可留空，若公司有合約審閱準則或既有已審閱合約庫（SharePoint）可選擇性連上。",
      "上傳合約檔案並下指令，若有特別在意的部分直接講明，例如「特別注意責任上限與資料保護條款」。",
      "先看回覆裡的意見彙整表決定優先順序，再打開加註解的 Word 檔逐條處理，最後把需要判斷的部分交給法務。"
    ],
    "example": "請審閱這份合約，找出任何風險、語意模糊之處或不尋常的條款。你會建議做哪些改善或釐清？",
    "license": "free"
  }
];
